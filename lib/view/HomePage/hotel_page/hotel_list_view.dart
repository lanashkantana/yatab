...
import 'package:test/view/HomePage/hotel_page/hotel_them.dart';
  ...
  class HotelListView extends StatefulWidget {
    const HotelListView(
        ...
        this.hotelData,
        this.callback,
        this.animation,required this.province,
                  ...
                  child: ClipRRect(
                    ...
                    child: Stack(
                      ...
                      isFavorite = !isFavorite; // Toggle favorite state
                                  ...
                                  child:isFavorite? Icon(Icons.favorite,color:Colors.red):
                                  Icon(Icons.favorite,color: HotelTheme.buildLightTheme().primaryColor),
