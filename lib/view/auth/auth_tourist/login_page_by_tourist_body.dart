...
class LoginPageByTouristBody extends StatefulWidget {
  const LoginPageByTouristBody({super.key});

  @override
  State<LoginPageByTouristBody> createState() => _LoginPageByTouristBodyState();
}

class _LoginPageByTouristBodyState extends State<LoginPageByTouristBody> {
